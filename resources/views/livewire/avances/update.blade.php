    ...
    <div class="modal-dialog modal-xl" role="document">
       <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateModalLabel">Actualizar Avance</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input wire:model="valorAnticipo" type="text" class="form-control" id="valorAnticipo" placeholder="Valoranticipo" disabled>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select wire:model="legalizado" class="form-control" id="legalizado" disabled>
                                    <option value="">-Seleccione una opción-</option>
                                    <option value="1">Registro</option>
                                    <option value="2">Solicitud Anticipo</option>
